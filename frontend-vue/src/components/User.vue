  ...
  <div class="container">
    ...
    <div class="input-group mb-3">
      ...
      <div class="input-group-append">
        <button type="button" class="btn btn-outline-secondary" @click="createUser()">Create User</button>
      </div>
    </div>
    ...
    <p></p>
    <h4 v-if="showRetrievedUser">{{retrievedUser.firstName}} {{retrievedUser.lastName}}</h4>
  </div>
</template>
